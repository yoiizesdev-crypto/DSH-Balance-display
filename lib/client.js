    ...
    function UpdateCard(props) {
      ...
      return react.createElement('div', { className: 'qs-card' },
        ...
        updateResult !== null
          ...
          : null,
        // When an in-plugin update fails, offer copyable text the user can
        // hand to a human/AI to perform the update instead.
        updateResult !== null && !updateResult.ok
          ? react.createElement('div', { className: 'qs-update-help' },
              react.createElement('span', { className: 'qs-update-help-label' }, '自动更新失败，可复制下面这句话让别人帮你更新：'),
