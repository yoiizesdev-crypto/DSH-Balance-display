  ...
  factory: (require) => {
    ...
    function loadUpdate(force) {
      ...
      fetch('/quota/update/check', {
        ...
        .catch(function () { /* keep previous result */ })
    ...
    /** 关于与更新 card: version, auto-check toggle, manual check button. */
      ...
      return react.createElement('div', { className: 'qs-card' },
        ...
        react.createElement('div', { className: 'qs-update-row' },
          ...
          react.createElement('button', {
            ...
            onClick: function () { loadUpdate(true) },
        ...
        upd !== null && upd.error === null && upd.hasUpdate
          ...
          : null,
        upd !== null && upd.error === null && !upd.hasUpdate && upd.latest !== null
