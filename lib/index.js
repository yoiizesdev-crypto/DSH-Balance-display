 ...
 * 14-18h Beijing). Input / output figures come from the official rate card.
 * The CACHE-HIT price is 0: DeepSeek V4's automatic Context Caching on Disk
 * is free, and the user's real bills confirm it — 2026-08-29: 152M cache
 * hits, billed spend $0.99, our input+output-only estimate $0.96 (charging
 * the docs' launch-era $0.007 would have shown $1.49, ~50% over).
 */
const PRICING = {
  'deepseek-v4-flash': {
