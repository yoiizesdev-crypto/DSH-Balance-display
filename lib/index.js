...
/**
 * Official CNY→USD conversion rate used by DeepSeek's own USD price list
 * (e.g. deepseek-chat $0.27 input ≈ 1.93 CNY ÷ 7.14). The API docs publish
 * CNY prices only, so USD usage cost is estimated with this fixed rate.
 */
const USD_RATE = 7.14

/** USD estimate of a CNY cost at the official fixed conversion rate. */
function costUsdOf(cny) {
  return cny / USD_RATE
}
