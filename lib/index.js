...
/** One update attempt; never throws — returns { ok, error?, current?, checked? }. */
async function applyUpdate() {
  // Route 1: git install — fast-forward the checked-out repo. Route 2: a
  // plain copy install (no .git) — download the tarball and overwrite files.
  // The first `git rev-parse` doubles as the detection: it throws when the
